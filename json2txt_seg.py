...
def labelme2yolov2Seg(jsonfilePath="", resultDirPath="", classList=["1","2"]):
    """
...
if __name__ == "__main__":
    jsonfilePath = r"data/silkworm-seg/json"  # 要转换的json文件所在目录
    resultDirPath = r"data/silkworm-seg/labels"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["1","2"])  # 更改为自己的类别名
